...
from .models import StudentModel, Generator, Discriminator, SmallGenerator, SmallDiscriminator
...
class AdvGAN(LightningModule):
    def __init__(
        ...
        # networks
        self.generator = Generator(self.gen_input_nc, self.image_nc)
        self.discriminator = Discriminator(self.image_nc)
