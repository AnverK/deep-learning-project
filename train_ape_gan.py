...
attack = AdvGAN.load_from_checkpoint(f'{Config.LOGS_PATH}/{Config.ADV_GAN_FOLDER}/last.ckpt', target_model_checkpoint_path=f'{Config.LOGS_PATH}/{Config.TARGET_MODEL_FOLDER}/last.ckpt')
attack.freeze()
attack.eval()
